...
const transitTree = _.flow(
  ...
  filteredArray => filteredArray.length === 0 ? `For route and schedule information,[I found this](${keywords.resources['transitRoutes']})` : `For pass and ticket information, [I found this](${keywords.resources['transitCard']})`
)
